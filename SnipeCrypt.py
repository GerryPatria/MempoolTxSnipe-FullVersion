...
import json,time,logging,webbrowser,subprocess,ctypes,sys,os,requests
...
def SNIPEBNB():
    ...
    if pair != web3.toChecksumAddress('0x0000000000000000000000000000000000000000'):
         print('[' + date_time + ']' + " [Info] Token Status : Found | [BUY] | Version BNB | [TRUE]" )
         LPBNB()
    else:
        print('[' + date_time + ']' + " [Info] Token Status : NotFound | [BUY] | Version BNB | [TRUE]" )
# Monitor Feature ------------------------------------------------------------------------------------------------------------- 
def monitor():
 checktime() 
 start_time = time.time()
